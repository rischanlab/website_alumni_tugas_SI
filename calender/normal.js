...
var gcCalBG="#d3d3d3";	//6699cc the background color of the outer calendar panel.
...
var gcSatBG="#919ca7";	// Saturday background color
var gcSun="black";	// Sunday font color
var gcSunBG="#919ca7";	// Sunday background color
